...
// }
//
// var t = new Tile(type, x, y);
//
// t.add();

$('.starting-tile').draggable({ grid: [100, 100], obstacle: '.second-tile', preventCollision: true });

$('.second-tile').draggable({ grid: [100, 100], obstacle: '.starting-tile', preventCollision: true });
