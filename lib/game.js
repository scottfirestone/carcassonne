...
class Game {
  ...
  buildPlayers() {
    ...
    // let playerName3 = dom('inputPlayerName3').val();
    // let playerName4 = dom('inputPlayerName4').val();
    // let playerName5 = dom('inputPlayerName5').val();
    let playerNames = [];
    ...
    //   new Player(player, color[i])
    // }
    let colors = ["red", "blue", "green", "yellow", "black"];

    playerNames.forEach(function (playerName, i) {
      this.players.push(new Player(playerName, colors[i-1]));
    }.bind(this));
