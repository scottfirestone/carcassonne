...
class Game {
  ...
  buttonBeginGameClicked(e) {
    ...
    // this.animations.sectionSwap('section-game', this.gameBeginAnimationCompleted.bind(this));
  }
  ...
  start() {
    ...
    let currentTimeDom = this.currentTile.dom;
    this.nextTurn();

    // dom('buttonPlaceTile').show(0);
    ...
    this.animations.sectionGameShow(
      this.gameShowAnimationCompleted.bind(this),
      currentTimeDom
    );
  }

  gameShowAnimationCompleted(info) {
