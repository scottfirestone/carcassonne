...
class Game {
  ...
  prepare() {
    this.animations.sectionShow('section-pre-game', this.prepareAnimationCompleted.bind(this));
  }
  ...
  buttonCreateGameClicked(e) {
    ...
    this.animations.sectionShow('section-player-input', this.gameCreateAnimationCompleted.bind(this));
  }
  ...
  buttonBeginGameClicked(e) {
    ...
    this.animations.sectionShow('section-game', this.gameBeginAnimationCompleted.bind(this));
  }
